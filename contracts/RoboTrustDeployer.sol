...
contract RoboTrustDeployer {
    ...
    function createTrust(uint256 _period, uint _numberOfYears, uint[] memory _paymentAmounts, uint _annuityPV, address _trustee, address _beneficiary, bool _showAccounting, string memory _disclaimer) public payable returns(address){
